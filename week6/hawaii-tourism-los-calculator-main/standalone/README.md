...
**AI Alteration:**
- Added Subresource Integrity (`integrity`) and `crossorigin="anonymous"` attributes to external CDN scripts (Chart.js and PapaParse).

**AI Alteration:**
- Added accessibility improvements in the standalone UI, including live-region announcements and a text summary for the chart.
