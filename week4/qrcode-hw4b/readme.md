...
- Reviewed code throughout prompting process to ensure functionality.
- Tested program.
- Manually troubleshot the cybersecurity message function as the intial formatting was not ideal.
...
- Validtion of URLs to ensure only URLs with valid formatting can be used to generate a QR code.
...
- Message added to SVG files: "Scan me. Please be mindfull of quishing attacks when scanning QR codes.". Users can now create a QR code and save it as a SVG file if they want the message to be included in output. 
...
- solution.js
- README.md
- output file generated on users device for created QR codes 
